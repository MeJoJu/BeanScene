...
namespace BeanScene2.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,FirstName,LastName,UserName,Password,Role,PermissionId")] User user)
        {
            ...
            ViewData["PermissionId"] = new SelectList(_context.Permission, "PermissionId", "PermissionId", user.PermissionId);
            return View(user);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BeanScene2Context.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
